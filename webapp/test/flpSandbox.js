		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#hogenthelloworldvclocal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hogenthelloworldvclocal-display": {
								"semanticObject": "hogenthelloworldvclocal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hogent.helloworldvclocal",
									"url": sap.ui.require.toUrl("hogent/helloworldvclocal")
								}
							}
						}
					}
